...
const bannerImages = {
  baeksuk: "images/menu/baeksuk.webp",
  meat: "images/menu/meat.webp",
  meal: "images/menu/meal.webp",
  season: "images/index/unamjeong-baeksuk.webp",
  extra: "images/index/unamjeong-baeksuk.webp",
  drink: "images/index/unamjeong-baeksuk.webp",
};
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (hash === "#meal-soup") {
    ...
    document
      .querySelector('#meal button[data-target="soup"]')
